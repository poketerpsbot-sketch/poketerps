...
const sources: readonly DemoMediaSource[] = [
  ...
  {
    seedKey: "demo.medicinal.oil",
    entryId: "10000000-0000-4000-8000-000000000015",
    categorySlug: "medicinal",
    imageId: "20000000-0000-4000-8000-000000000015",
    commonsFileTitle: "File:Golden Cannabis Oil.JPG",
    sourcePage: "https://commons.wikimedia.org/wiki/File:Golden_Cannabis_Oil.JPG",
    author: "H",
    licenseName: "Public domain",
    licenseUrl: "https://commons.wikimedia.org/wiki/Commons:Public_domain",
    altText: "Photo d’illustration : huile de cannabis à la teinte dorée.",
  },
  {
    seedKey: "demo.medicinal.capsules",
    entryId: "10000000-0000-4000-8000-000000000016",
    categorySlug: "medicinal",
    imageId: "20000000-0000-4000-8000-000000000016",
    commonsFileTitle: "File:Softgels.jpg",
    sourcePage: "https://commons.wikimedia.org/wiki/File:Softgels.jpg",
    author: "Globallystoners",
    licenseName: "CC0",
    licenseUrl: "https://creativecommons.org/publicdomain/zero/1.0/",
    altText: "Photo d’illustration : capsules molles génériques de couleur ambrée.",
  },
  {
